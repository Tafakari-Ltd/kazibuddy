...
const CategoriesPage = () => {
  ...
  const handleCreateInputChange = (
    ...
    if (createFormErrors[name as keyof typeof createFormErrors]) {
  ...
  const handleCreateSubmit = async (e: React.FormEvent) => {
    ...
    await handleCreateCategory(createFormData.name, createFormData.description);
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Manage job categories and their details
          </p>
        </div>
        <button
          type="button"
            ...
            >
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6 text-sm">
                  ...
                  cannot be undone and may affect related jobs.
                </p>
              </div>
