...
export default function ApplicationDetailsPage() {
  ...
  const { application, isLoading, apiError, updateDetails } =
          ...
          <div className="px-6 py-6 border-b border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <span
                  className={`mt-1 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(application.status)}`}
                >
                  {application.status.charAt(0).toUpperCase() +
                    application.status.slice(1)}
                </span>
          ...
          <div className="px-6 py-6">
            ...
            <div className="space-y-4">
              ...
              {application.responded_at && (
                <div className="flex items-center">
                  <div
                    className={`flex-shrink-0 w-2 h-2 rounded-full ${application.status === "accepted" ? "bg-green-500" : "bg-red-500"}`}
                  ></div>
                  <div className="ml-4">
                    <p className="text-sm font-medium text-gray-900">
                      Response Received
                    ...
                    <p className="text-sm text-gray-600">
                      {new Date(application.responded_at).toLocaleString()}
                    </p>
                  </div>
                </div>
              )}
