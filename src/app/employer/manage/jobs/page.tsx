  ...
  const handleStatusToggle = useCallback(
    async (job: Job) => {
      const newStatus: JobStatus =
        job.status === JobStatus.ACTIVE ? JobStatus.PAUSED : JobStatus.ACTIVE;
                        ...
                        <div className="flex items-center space-x-4 text-xs text-gray-400">
                          ...
                          <span className="flex items-center">
                            ...
                            {job.job_type
                              ...
                              .charAt(0)
                              .toUpperCase() +
                              job.job_type.replace("_", " ").slice(1)}
                          </span>
                          {job.estimated_hours && (
                            <span className="flex items-center">
                              <Clock className="w-3 h-3 mr-1" />
          ...
          <div className="bg-white rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <span
                  className={`px-2 py-1 rounded-full text-sm font-medium ${getStatusColor(selectedJob.status)}`}
                >
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900">
                    {formatCurrency(selectedJob.budget_min)} -{" "}
                    {formatCurrency(selectedJob.budget_max)}
                  </p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                  ...
                  <p className="text-gray-900 capitalize">
                    {selectedJob.payment_type.replace("_", " ")}
                  </p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900">
                    {selectedJob.estimated_hours || "Not specified"}
                  </p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                  ...
                  <p className="text-gray-900">
                    {selectedJob.max_applicants || "Unlimited"}
                  </p>
                </div>
              </div>
            </div>
