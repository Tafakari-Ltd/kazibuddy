      ...
      <div className="container mb-8">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg text-gray-600 mb-6">
            Connect with verified workers in your area. Browse profiles, check availability, 
            and hire the right person for your project.
          </p>
          ...
          <div className="bg-white rounded-lg w-full max-w-md p-6">
            ...
            <div className="mb-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h4 className="font-semibold">Worker #{selectedWorker.id.substring(0, 8)}</h4>
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">${selectedWorker.hourly_rate}/hr</span>
                </div>
                <div className="flex justify-between">
                  <span>Availability:</span>
                  <span className={`font-medium ${
                    selectedWorker.is_available ? 'text-green-600' : 'text-gray-600'
                  }`}>
