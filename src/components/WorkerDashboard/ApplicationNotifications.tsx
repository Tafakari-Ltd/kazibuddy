...
const ApplicationNotifications = () => {
  ...
  const fetchApplicationUpdates = async () => {
    try {
      ...
      const respondedApplications = response.applications.filter(
        (app) =>
          app.responded_at &&
      ...
      const newNotifications: NotificationItem[] = respondedApplications.map(
        (app) => ({
              ...
              {!loading && notifications.length === 0 && (
                <div className="p-6 text-center">
                  ...
                  <p className="text-gray-600 text-sm">
                    You'll receive notifications when employers respond to your
                    applications
                  </p>
                </div>
              )}
                        ...
                        <div className="space-y-1 text-sm text-gray-700">
                          <div className="flex items-center gap-1">
                            ...
                            <span className="font-medium">
                              {notification.application.job_details?.title}
                            </span>
                          </div>
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            <span>
                              {
                                notification.application.employer_details
                                  ?.company_name
                              }
                            </span>
                          </div>
                          ...
                          {notification.type === "accepted" && (
                            <div className="flex items-center gap-1 text-green-700">
                              ...
                              <span>
                                Rate:{" "}
                                {formatCurrency(
                                  notification.application.proposed_rate,
                                )}
                              </span>
                            </div>
                          )}
                        ...
                        {notification.type === "accepted" && (
                          <div className="mt-3 p-2 bg-green-100 border border-green-200 rounded-lg">
                            <p className="text-green-800 text-xs font-medium">
                              ...
                              approved by the admin team. The employer will
                        ...
                        {notification.type === "rejected" && (
                          <div className="mt-3 p-2 bg-red-100 border border-red-200 rounded-lg">
                            <p className="text-red-800 text-xs">
                              Your application was not selected this time. Keep
