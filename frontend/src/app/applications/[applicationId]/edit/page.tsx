...
export default function EditApplicationPage() {
  ...
  const validateForm = (): boolean => {
    const validation = JobApplicationApi.validateApplicationData(
      formData as any,
    );
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-700 mt-1">
                  This application has already been {application.status} and
                  cannot be edited.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <textarea
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, worker_notes: e.target.value })
                  }
                  className={`w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-vertical ${
